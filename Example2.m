...
figure(1)
plot(t_plot, xbar1(:,round(N_z/2)),'k-',t_plot, xhbar1(:,round(N_z/2)),'k:')
xlim([0 tf]);
xlabel('time (sec.)', 'fontname','Times New Roman', 'FontSize',8);
set(gca,'fontname','Times New Roman', 'FontSize',8);
h=legend('$$z_1(1/2,a)$$','$$\hat{z}_1(1/2,a)$$','1');
set(h,'Interpreter','latex');

figure(2)
plot(t_plot, xbar2(:,round(N_z/2)),'k-',t_plot, xhbar2(:,round(N_z/2)),'k:')
xlim([0 tf]);
xlabel('time (sec.)', 'fontname','Times New Roman', 'FontSize',8);
set(gca,'fontname','Times New Roman', 'FontSize',8);
h=legend('$$z_2(1/2,a)$$','$$\hat{z}_2(1/2,a)$$','1');
set(h,'Interpreter','latex');
